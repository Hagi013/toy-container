...
fn check_waiting4(regs: user_regs_struct) -> bool {
    // rdi == 4294967295(-1) の場合、全ての子プロセスを待つということ
    // ref: https://nxmnpg.lemoda.net/ja/2/wait4
    regs.orig_rax == libc::SYS_wait4 as u64 && regs.rax == 18446744073709551578 && regs.rdi == 4294967295
}